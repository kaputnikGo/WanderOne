...
Crafty.scene('Game', function() {
	...
	// place ladder on the map in random location
...
Crafty.scene('Loading', function(){
	...
	Crafty.load([
		'wander/assets/16x16_forest_2.gif',
		'wander/assets/hunter.png',
		'wander/assets/ladder.png'
		...
		Crafty.sprite(16, 'wander/assets/16x16_forest_2.gif', {
			spr_tree:    [0, 0],
			spr_bush:    [1, 0],
			spr_village: [0, 1],
			spr_rock:    [1, 1]
		...
		// Define the ladder sprite, will be randomly placed
		Crafty.sprite(16, 'wander/assets/ladder.png', {
			spr_ladder:  [0, 0]
		});

		// Define the PC's sprite to be the first sprite in the third row of the
		//  animation sprite map
		Crafty.sprite(16, 'wander/assets/hunter.png', {
			spr_player:  [0, 2],
		}, 0, 2);
